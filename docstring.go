...
Amount of time in milliseconds to wait before displaying a loading message
when a file or directory is loading. Setting this to a low value can cause
the loading message to flicker when browsing through files or directories.
Setting this to a high value can cause the loading message to appear delayed if
a file or directory takes a while to load.
