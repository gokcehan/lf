...
complete -c lf -o last-dir -d 'print the last dir to stdout on exit (to use for cd)'
...
complete -c lf -o selection -d 'print the selected files to stdout on open (to use as open file dialog)'
