...
Some other possibilities to consider for the preview cursor: "%s" for no cursor, "\033[7;2m%s\044[0m" for dimmed inverted text (visibility varies by terminal), "\033[7;90m%s\044[0m" for inverted text with grey (aka "brightblack") background.
